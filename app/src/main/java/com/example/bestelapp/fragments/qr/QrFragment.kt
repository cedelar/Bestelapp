...
class QrFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Value init
        val binding = DataBindingUtil.inflate<FragmentQrBinding>(
            inflater,
        ...
        // Observers
        qrViewModel.navigateToTitle.observe(
            viewLifecycleOwner,
            {
                if (it == true) {
                    this.findNavController()
                        .navigate(QrFragmentDirections.actionQrFragmentToTitleFragment())
                    qrViewModel.doneNavigating()
                }
            }
        )

        qrViewModel.errorMessage.observe(
            viewLifecycleOwner,
            {
